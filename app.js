...
function renderHomePage() {
    appContent.innerHTML = `
        <section id="hero" class="pt-24 pb-32 text-center" style="min-height: 400px;">
            <h1 class="h1-zen max-w-4xl mx-auto mb-6 animated-item animation-delay-1200 px-4">Prakiraan Cuaca Indonesia (BMKG)</h1>
            <p class="body-lg-zen max-w-2xl mx-auto mb-10 animated-item animation-delay-1400 px-4">Masukkan nama Desa atau Kelurahan untuk mendapatkan prakiraan cuaca BMKG terkini.</p>
            
            <form id="weather-search-form" class="flex justify-center mb-16 animated-item animation-delay-1600 px-4">
                <div class="bg-white rounded-[24px] shadow-lg p-2 sm:p-3 w-full max-w-2xl relative" style="box-shadow: rgb(207, 207, 207) 0px -3px 0px inset;">
                    
                    <div class="flex flex-col sm:flex-row gap-2 sm:gap-4">
                        <input type="text" id="village-search-input" placeholder="Masukkan nama Desa/Kelurahan..." 
                               class="flex-grow p-3 sm:p-4 rounded-[16px] border-2 border-gray-200 focus:border-[#2B8A9E] transition duration-200 text-[#2C2C2C] text-base sm:text-lg outline-none" 
                               style="box-shadow: none;" required>
                        <button type="submit" id="search-btn" class="btn-primary-zen flex-shrink-0 px-6 sm:px-8 py-3 w-full sm:w-auto">Cari</button>
                    </div>

                    <ul id="suggestion-list" class="absolute z-10 w-[calc(100%-1rem)] sm:w-[95%] left-1/2 -translate-x-1/2 mt-2 bg-white border border-gray-200 rounded-xl shadow-xl max-h-60 overflow-y-auto hidden">
                        </ul>
                </div>
            </form>
